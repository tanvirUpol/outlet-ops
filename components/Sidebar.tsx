...
const Sidebar = () => {
    ...
    return (
        <div className={` ${isCollapsed ? 'sticky' : 'fixed sm:sticky'} top-0 left-0 flex h-screen text-sm ${isCollapsed ? 'w-20' : 'w-64'} bg-gray-800  z-40 text-white transition-all duration-200 p-2 md:p-4`}>
